...
class WindowClass(QMainWindow, form_class):
        ...
        if e.mimeData().hasUrls:
            ...
            if os.path.isdir(dir_path):
                ...
                if not self.isSetInput:
                    ...
                    self.lineEdit_output.setStyleSheet("color: black;")
    ...
    def make_rst_path(self):
        ...
        while True:
            ...
            if r_id not in digit_stack:
                ...
                self.output_path = f"{self.output_file_path}{os.sep}result{r_id}{os.sep}QualityImg"
                os.makedirs(path)
                self.output_file_path = path
                break
    ...
    def update_output_dir_num(self):
        path = f"{self.output_path}\\*.png"
        len_output_dir = len(glob(path))
    ...
    def finish_task(self):
        ...
        self.btn_execute.setEnabled(False)
        self.lineEdit_input.setStyleSheet("color: gray;")
        self.lineEdit_output.setStyleSheet("color: gray;")
        self.isSetInput = False
        self.isSetOutput = False
